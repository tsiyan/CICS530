...
package jp.ohwada.android.alarmclocksample;
...
//        Log.v("mAlarmPref = " + mAlarmPref.toString());
//        Log.v("mAlarmPref.mAlert = " + mAlarmPref.mAlert);
  ...
  //      updateTime();
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        updateTime();        
        //saveAlarm(true);       
        Alarms.setAlarm(this, mId, mAlarmOnPref.isChecked(), mHour, mMinutes,
                mDaysOfWeek, mVibratePref.isChecked(),
                mLabel.getText(), "default_ringtone");
//        mLabel.getText(), mAlarmPref.mAlert.toString());
    }
